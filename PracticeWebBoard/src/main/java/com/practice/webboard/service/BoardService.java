...
import com.practice.webboard.repository.BoardFileRepository;
	...
	public void save( BoardDTO boardDTO ) throws IOException {
		if(boardDTO.getBoardFile().isEmpty() ) {
			...
			for(MultipartFile boardFile :boardDTO.getBoardFile()) {
				...
				String savaPath = "C:/workspace/web/practice-web-board/PracticeWebBoard/src/main/resources/templates/filestorage/"+storedFileName;
